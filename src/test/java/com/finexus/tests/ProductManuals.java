...
public class ProductManuals {
  ...
  @Test
  public void testProductManuals() throws Exception {
    driver.get("https://www.everlast.com/");
    driver.findElement(By.id("ui-id-2")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Loading...'])[3]/following::div[12]")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='o'])[2]/following::div[7]")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='o'])[2]/following::div[7]")).click();
    driver.findElement(By.linkText("Product Manuals")).click();
