...
public class WrongLogins {
  ...
  @Test
  public void testWrongLogins() throws Exception {
    ...
    driver.findElement(By.id("email")).sendKeys("noorkhan@gmail.com");
    driver.findElement(By.id("pass")).click();
    driver.findElement(By.id("pass")).clear();
    driver.findElement(By.id("pass")).sendKeys("noorkhan@");
    ...
    // ERROR: Caught exception [ERROR: Unsupported command [doubleClick | xpath=(.//*[normalize-space(text()) and normalize-space(.)='Customer Login'])[2]/following::div[6] | ]]
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Customer Login'])[2]/following::div[6]")).click();
    driver.findElement(By.id("maincontent")).click();
    // ERROR: Caught exception [ERROR: Unsupported command [doubleClick | id=maincontent | ]]
  }
