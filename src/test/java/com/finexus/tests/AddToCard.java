...
public class AddToCard {
  ...
  public void testAddToCard() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Deals'])[1]/following::span[1]")).click();
    ...
    driver.findElement(By.id("option-label-color-92-item-514")).click();
