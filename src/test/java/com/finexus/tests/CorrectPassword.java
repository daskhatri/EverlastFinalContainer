...
public class CorrectPassword {
  ...
  public void testCorrectPassword() throws Exception {
    ...
    driver.findElement(By.id("email")).sendKeys("softtech@gmail.com");
    driver.findElement(By.id("pass")).click();
    driver.findElement(By.id("pass")).clear();
    driver.findElement(By.id("pass")).sendKeys("everlast#123");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Sign in to your Everlast Account'])[1]/following::fieldset[1]")).click();
